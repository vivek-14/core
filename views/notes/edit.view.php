    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <form method="POST" action="/note">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <a href="<?= "/note?id={$note['id']}" ?>" class="bg-transparent hover:bg-gray-500 text-gray-700 font-semibold hover:text-white py-2 px-4 border border-gray-500 hover:border-transparent rounded">Go back</a>
